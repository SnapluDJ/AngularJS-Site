...
var coffee = angular.module('coffee', ['ngRoute', 'coffeeController']);
...
var coffeeController = angular.module('coffeeController', []);

coffeeController.controller('coffeeCtrl', ['$scope', '$routeParams', '$rootScope',
	function ($scope, $routeParams, $rootScope) {
		$scope.coffees =
	       ...
	       for (var c in $scope.coffees) {
	       		if ($scope.coffees[c].id == $routeParams.coffeeId) {
	       			$rootScope.selectedCoffee = $scope.coffees[c];
	       		}
	       }
	}]);
